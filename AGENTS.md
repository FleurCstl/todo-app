...
11. **Git Commit Hygiene**: 
    ...
    - Every commit MUST include a `Co-authored-by` trailer using the current agent's identity and model (e.g., `Antigravity (Gemini 3 Flash) <antigravity@googlemind.com>`).
